  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.html"><img src="/admin/images/logo-" title="${siteName!""}" alt="${siteName!""}" /></a>
      </div>
                ...
                <form action="add" id="user-add-form" method="post" class="row">
                      ...
                      <ul class="list-inline clearfix lyear-uploads-pic">
                        <li class="col-xs-4 col-sm-3 col-md-2">
                          <figure>
                    		...
                    		<img src="/photo/view?filename=${user.image}" id="show-picture-img">
                    		<#else>
                        ...
                        <input type="file" id="select-file" style="display:none;" onchange="upload('show-picture-img','image')">
                        <li class="col-xs-4 col-sm-3 col-md-2">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <select name="role" class="form-control" id="role">
                    	<#list roles as role>
                    	<option value="${role.id}" <#if user.role == role.id>selected</#if> >${role.name}</option>
                    	</#list>
                    </select>
                  </div>
                  <div class="input-group m-b-10">
