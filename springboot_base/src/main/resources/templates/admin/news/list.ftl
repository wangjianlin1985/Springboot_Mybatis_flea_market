...
<title>${siteName!""}|新闻公告管理-${title!""}</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageResult.content as news>
                      <tr>
                        ...
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${news.createTime?string('yyyy-MM-dd HH:mm:ss')}</font></td>
                      </tr>
                    </#list>
                    <#else>
                ...
                <ul class="pagination ">
                  ...
                  <li class="disabled"><a href="list?title=${newsTitle!""}&currentPage=1"><span>第一页</span></a></li>
                  <#else>
                    <li><a href="list?title=${newsTitle!""}&currentPage=${pageResult.currentPage-1}">上一页</a></li>
                  </#if>
                    <li><span>第【${pageResult.currentPage}】页</span></li>
                    <#if pageResult.currentPage == pageResult.totalPage>
                  <li class="disabled"><a href="list?title=${newsTitle!""}&currentPage=${pageResult.totalPage}"><span>最后一页</span></a></li>
                    <#else>
                    <li><a href="list?title=${newsTitle!""}&currentPage=${pageResult.currentPage+1}">下一页</a></li>
                    </#if>
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('新闻公告删除成功!',function(){
