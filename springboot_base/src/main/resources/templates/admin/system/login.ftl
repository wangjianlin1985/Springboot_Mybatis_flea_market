  ...
  <div class="lyear-login">
    <div class="login-center">
      <div class="login-header text-center">
        <a href=""> <img alt="light year admin" src="/admin/images/logo-1.png"></a>
      </div>
      <form id="login_form" method="post">
        <div class="form-group has-feedback feedback-left">
          <input type="text" placeholder="请输入您的用户名" class="form-control required" name="username" id="username" value="" tips="请填写用户名" />
          <span class="mdi mdi-account form-control-feedback" aria-hidden="true"></span>
        </div>
        <div class="form-group has-feedback feedback-left">
          <input type="password" placeholder="请输入密码" class="form-control required" id="password" name="password" value="" tips="请填写密码" />
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2020 <a href="">【广东理工学院】</a>. All right reserved</p>
      </footer>
    </div>
  </div>
</div>
