                  ...
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">操作者</a> </li>
                      </ul>
                    </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="vertical-align:middle;">
                          <label class="lyear-checkbox checkbox-primary">
                            <input type="checkbox" name="ids[]" value="${Log.id}"><span></span>
                          </label>
                        </td>
                        <td style="vertical-align:middle;">${Log.operator}</td>
                        <td style="vertical-align:middle;">${Log.content}</td>
                        <td style="vertical-align:middle;"><font class="text-success">${Log.createTime?string('yyyy-MM-dd HH:mm:ss')}</font></td>
                      </tr>
                    </#list>
                    <#else>
	...
	$.confirm({
        ...
        buttons: {
            confirm: {
                text: '确认',
                action: function(){
                    ajaxRequest(url,'DELETE',{},function(rst){
