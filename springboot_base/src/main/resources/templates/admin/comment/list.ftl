              ...
              <div class="card-toolbar clearfix">
                  <form class="pull-right search-bar" method="get" action="list" role="form">
                      <div class="input-group">
                          ...
                          <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入商品名">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageResult.content as comment>
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                        	<a href="/home/goods/detail?id=${comment.good.id}" target="_blank">
                        	<img src="/photo/view?filename=${comment.good.photo}" width="30px" height="30px">
                       		</a>
                        </td>
                        <td style="vertical-align:middle;">
                        	<a href="/home/goods/detail?id=${comment.good.id}" target="_blank">${comment.good.name}</a>
                        </td>
                        <td style="vertical-align:middle;">
                        	${comment.student.sno}
                        </td>
                        ...
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${comment.createTime?string('yyyy-MM-dd HH:mm:ss')}</font></td>
                      </tr>
                    </#list>
                    <#else>
