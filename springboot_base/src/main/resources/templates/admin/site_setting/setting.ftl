                      ...
                      <ul class="list-inline clearfix lyear-uploads-pic">
                        <li class="col-xs-4 col-sm-3 col-md-2">
                          <figure>
                            <#if siteSetting??>
                            <#if siteSetting.logo1??>
                            <img src="/photo/view?filename=${siteSetting.code}" id="show-qrcode-img" >
                          	<#else>
                        ...
                        <input type="hidden" name="code" id="qrcode" value="<#if siteSetting??><#if siteSetting.code??>${siteSetting.code}</#if></#if>">
