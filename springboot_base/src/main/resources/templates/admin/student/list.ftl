            ...
            <div class="card">
              <div class="card-toolbar clearfix">
                <form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="${sno!""}" name="sno" placeholder="请输入学生学号">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <#list pageResult.content as student>
                      <tr>
                        ...
                        <td style="vertical-align:middle;">
                    		<#if student.image??>
                    		<img src="/photo/view?filename=${student.image}" width="60px" height="60px">
                    		<#else>
                    		<img src="/home/imgs/avatar4.png" width="60px" height="60px">
                    		</#if>
                        </td>
                        <td style="vertical-align:middle;">${student.sno}</td>
                        ...
                        <td style="vertical-align:middle;">${student.wx!""}</td>
                        ...
                        <td style="vertical-align:middle;" style="vertical-align:middle;"><font class="text-success">${student.createTime?string('yyyy-MM-dd HH:mm:ss')}</font></td>
                      </tr>
                    </#list>
                    <#else>
                ...
                <ul class="pagination ">
                  ...
                  <li class="disabled"><a href="list?sno=${sno!""}&currentPage=1"><span>第一页</span></a></li>
                  <#else>
                    <li><a href="list?sno=${sno!""}&currentPage=${pageResult.currentPage-1}">上一页</a></li>
                  </#if>
                    <li><span>第【${pageResult.currentPage}】页</span></li>
                    <#if pageResult.currentPage == pageResult.totalPage>
                  <li class="disabled"><a href="list?sno=${sno!""}&currentPage=${pageResult.totalPage}"><span>最后一页</span></a></li>
                    <#else>
                    <li><a href="list?sno=${sno!""}&currentPage=${pageResult.currentPage+1}">下一页</a></li>
                    </#if>
...
function freeze(url){
	...
	var id = $("input[type='checkbox']:checked").val();
	ajaxRequest('update_status','put',{id:id,status:0},function(){
		alert('冻结成功');
...
function openStudent(url){
	...
	var id = $("input[type='checkbox']:checked").val();
	ajaxRequest('update_status','put',{id:id,status:1},function(){
		alert('激活成功');
		window.location.reload();
	});
}
