    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
                ...
                <div class="inputOuter" id="uArea">
                    <input type="text" id="login-sn" name="sno" class="inputstyle" value=""/>
                </div>
                </div>
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                <li>
                    ...
                    <div class="inputOuter2">
                        <input type="text" id="user-sn" name="sno" maxlength="13" class="inputstyle2"/>
                    </div>
                ...
                <li>
                 <label for="name" class="input-tips2">名字：</label>
                    <div class="inputOuter2">
                ...
                <li>
                    <div class="inputArea">
                        <input type="button" id="reg_button"  style="margin-top:10px;margin-left:85px;" class="button_blue" value="立即注册"/>
                    </div>
