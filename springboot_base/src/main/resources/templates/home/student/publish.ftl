                ...
                <div class="form-wr">
                    <div class="form-must-wr">
                        ...
                        <div class="form-item l goods-title">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input id="name" name="name" placeholder="商品名称长度最多50个字" maxlength="50" value="" type="text" class="required" tips="请填写商品名称"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-item xl goods-desc">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <textarea name="describle" id="desc" placeholder="建议填写物品用途、新旧程度、原价等信息，至少6个字" class="required" tips="请填写详情描述"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-item l goods-price">
                            ...
                            <div class="form-value">
                                <div class="form-input-wr">
                                    <input class="price required" id="price" name="price" value="" type="number"  placeholder="出售价格必须为数字"  tips="请填写出售价格"></div>
                            </div>
                        </div>
